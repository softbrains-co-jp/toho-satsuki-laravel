...
class VHouseConst extends Model
{
    protected $table = 'v_house_const';
    ...
    public function mKkk005()
    {
        return $this->belongsTo('App\Models\MMerchant', 'kkk_005', 'id');
    }
    ...
    public function mKkk019()
    {
        return $this->belongsTo('App\Models\MExistence2', 'kkk_019', 'id');
    }

    public function mKkk020()
    {
        return $this->belongsTo('App\Models\MExistence2', 'kkk_020', 'id');
    }
    ...
    public function mKkk011()
    {
        return $this->belongsTo('App\Models\MHouseConstResult', 'kkk_011', 'id');
    }
    ...
    public function mKkk014()
    {
        return $this->belongsTo('App\Models\MRouteChange', 'kkk_014', 'id');
    }

    public function mRko060()
    {
        return $this->belongsTo('App\Models\MCableConnect', 'rko_060', 'id');
    }

    public function mRko065()
    {
        return $this->belongsTo('App\Models\MDirectReason', 'rko_065', 'id');
    }

    public function mRko063()
    {
        return $this->belongsTo('App\Models\MCodeLength1', 'rko_063', 'id');
    }

    public function mRko066()
    {
        return $this->belongsTo('App\Models\MExistence2', 'rko_066', 'id');
    }

    public function mKkk015()
    {
        return $this->belongsTo('App\Models\MExistence1', 'kkk_015', 'id');
    }
}
