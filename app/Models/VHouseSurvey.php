...
class VHouseSurvey extends Model
{
    protected $table = 'v_house_survey';
    ...
    public function mTck004()
    {
        return $this->belongsTo('App\Models\MMerchant', 'tck_004', 'id');
    }
    ...
    public function mTck012()
    {
        return $this->belongsTo('App\Models\MExistence2', 'tck_012', 'id');
    }

    public function mTck013()
    {
        return $this->belongsTo('App\Models\MExistence2', 'tck_013', 'id');
    }
