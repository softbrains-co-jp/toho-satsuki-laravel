<div wire:poll.{{ $refreshIntervalSeconds }}s="refreshExclusion">
    <table class="satsuki-table tw:w-full">
        ...
        <tr>
            ...
            <th>住居所有区分</th>
            <td>{{ $vBasicInfo?->mHouseOwnership?->val }}</td>
        </tr>
        <tr>
            <th>設置先住所</th>
        ...
        <tr>
            ...
            <th>回線速度</th>
            <td>{{ $vBasicInfo?->mLineSpeed?->val }}</td>
            <td colspan="2"></td>
        </tr>
        <tr>
            <th>申込書備考欄</th>
            <td colspan="7">{!! nl2br($vBasicInfo?->rke_032) !!}</td>
        </tr>
        <tr>
            <th>申込ID</th>
        ...
        <tr>
            <th>ISP変更フラグ</th>
            <td>{{ $vBasicInfo?->mExistence1_043?->val }}</td>
            <th>強制解約フラグ</th>
            <td>{{ $vBasicInfo?->mExistence1_239?->val }}</td>
            <td colspan="4"></td>
        </tr>
    </table>
