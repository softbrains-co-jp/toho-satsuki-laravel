<div>
    @csrf
    <x-section-title>パスワード変更</x-section-title>
    <div class="tw:text-black tw:mt-[20px]">
    ...
    <x-error-message name="oldPassword" />
    ...
    <x-error-message name="newPassword" />
    ...
    <x-error-message name="newPasswordConfirm" />

    <div class="tw:w-[400px] tw:mt-[30px] tw:text-center">
        <x-button.red
